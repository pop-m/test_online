...
<body background="image/demo-1-bg.jpg" onLoad="jishiqi();"> 
	...
	$position="localhost";
	$linkInfo=array("Database"=>"db_online","UID"=>"sa","PWD"=>"centos");
	...
	<!-- 第一题-->
			...
			<div class="examOut">
				<div id="examination" class="examination">
					<div id="questionNum" class="questionNum">
						<img src="image/1.png" class="questionNumImg">
					</div>
		...
		<!-- 第二题 -->
			<div class="examOut">
				<div id="examination" class="examination">
					<div id="questionNum" class="questionNum">
						<img src="image/2.png" class="questionNumImg">
					</div>
			...
			<div class="examOut">
				<div id="examination" class="examination">
					<div id="questionNum" class="questionNum">
						<img src="image/3.png" class="questionNumImg">
					</div>
			...
			<div class="examOut">
				<div id="examination" class="examination">
					<div id="questionNum" class="questionNum">
						<img src="image/4.png" class="questionNumImg">
					</div>
			...
			<div class="examOut">
				<div id="examination" class="examination">
					<div id="questionNum" class="questionNum">
						<img src="image/5.png" class="questionNumImg">
					</div>
